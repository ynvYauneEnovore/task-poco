...
<link rel="stylesheet" type="text/css" href="<?php echo e(route('/')); ?>/assets/css/summernote.css">
...
<script src="<?php echo e(route('/')); ?>/assets/js/editor/summernote/summernote.js"></script>
<script src="<?php echo e(route('/')); ?>/assets/js/editor/summernote/summernote.custom.js"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/webiotspc/Documents/Poco-Laravel/laravel/template/resources/views/new_apps/summernote.blade.php ENDPATH**/ ?>