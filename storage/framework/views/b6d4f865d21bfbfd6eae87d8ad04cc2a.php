<?php $__env->startSection('title', 'Animation'); ?>
                     ...
                     <div id="animation-box">
                        <div class="card">
                           <div class="animate-widget">
                              <div><img class="img-fluid" src="<?php echo e(route('/')); ?>/assets/images/banner/3.jpg" alt=""></div>
...
<script src="<?php echo e(route('/')); ?>/assets/js/animation/animate-custom.js"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ramona\Downloads\template\pocoadmin-23\pocoadmin-23\laravel\template\resources\views/perk-ui/animate.blade.php ENDPATH**/ ?>