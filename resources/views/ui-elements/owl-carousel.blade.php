         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="owl-carousel owl-theme" id="owl-carousel-5">
                  <div class="item"><img src="{{route('/')}}/assets/images/slider/1.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/11.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/12.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/13.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/14.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/15.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/11.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/12.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/13.jpg" alt=""></div>
                  <div class="item"><img src="{{route('/')}}/assets/images/slider-auto-width/14.jpg" alt=""></div>
