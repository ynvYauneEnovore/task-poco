      ...
      <div class="row">
         ...
         <div class="col-sm-12">
            <div class="card">
               ...
               <div class="card-body avatar-showcase">
                  <div class="avatars">
                     <div class="avatar"><img class="img-100 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-90 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-80 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-70 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-60 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-50 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-40 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-20 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                     <div class="avatar"><img class="img-10 rounded-circle" src="{{ asset('assets/images/user/14.png') }}" alt="#"></div>
                  </div>
               </div>
            </div>
         </div>
